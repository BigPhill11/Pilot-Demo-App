...
// Careers in Finance Section (flashcards cleared — content coming soon)
export const careersInFinanceSection: FlashcardSection = {
  ...
  icon: '💼',
  subsections: [
    { id: 'investment-banking', title: 'Investment Banking', description: 'Help companies raise capital and execute deals', icon: '🏦', cards: [] },
    { id: 'asset-management', title: 'Asset Management', description: 'Manage investments for clients', icon: '📈', cards: [] },
    { id: 'private-equity', title: 'Private Equity', description: 'Invest in and improve private companies', icon: '🔐', cards: [] },
    { id: 'venture-capital', title: 'Venture Capital', description: 'Fund high-growth startups', icon: '🚀', cards: [] },
    { id: 'hedge-funds', title: 'Hedge Funds', description: 'Use advanced strategies for wealthy investors', icon: '📊', cards: [] },
    { id: 'consulting', title: 'Management Consulting', description: 'Advise companies on strategy and operations', icon: '💡', cards: [] },
  ],
};
