...
import { pandasFirstPaycheckGame } from '@/data/personal-finance/boss-games/pandas-first-paycheck';
    ...
    <div className="max-w-2xl mx-auto p-4 space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="text-center">
          <h2 className="font-bold text-lg">Month {gameState.currentMonth} of {game.totalMonths}</h2>
