...
export const BUILDING_DEFINITIONS: Record<BuildingType, BuildingDefinition> = {
  ...
  training_dojo: {
    id: 'training_dojo',
    name: 'Training Dojo',
    description: 'Boosts farm production and unlocks rest, workout, and social programs.',
    educationalDescription: 'The Training Dojo represents investing in human capital, health, and sustainable work habits. Skills increase earning power, while rest and exercise protect productivity from burnout.',
    cost: 150,
    size: { width: 2, height: 2 },
    constructionTime: 45,
    maxLevel: 5,
