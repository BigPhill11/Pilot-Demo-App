...
import type { EmailLessonConfig } from '@/data/career-readiness/email-etiquette';
import type { LessonTestItem } from '@/data/career-readiness/interviewing';
import { useQuizRecorder } from '@/hooks/useQuizRecorder';
import type { QuizContext } from '@/lib/quizTelemetry';

interface EmailLessonTestCheckpointProps {
  lesson: EmailLessonConfig;
...
const EmailLessonTestCheckpoint: React.FC<EmailLessonTestCheckpointProps> = ({
  lesson,
  results,
  onResult,
  onReset,
...
export default EmailLessonTestCheckpoint;
