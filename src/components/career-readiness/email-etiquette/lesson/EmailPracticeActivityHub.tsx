...
import { EMAIL_ACTIVITY_LABELS } from '@/data/career-readiness/email-etiquette';
import type { EmailActivityId } from '@/types/career-readiness';

interface EmailPracticeActivityHubProps {
  activityIds: EmailActivityId[];
...
const EmailPracticeActivityHub: React.FC<EmailPracticeActivityHubProps> = ({
  activityIds,
    ...
    <div className="space-y-3">
      ...
      <div className="flex gap-2 overflow-x-auto pb-1 -mx-1 px-1">
        {activityIds.map((id, index) => {
          const meta = EMAIL_ACTIVITY_LABELS[id];
...
export default EmailPracticeActivityHub;
